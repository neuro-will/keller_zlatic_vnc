""" Tests for decision dependence in DFF, looking across multiple different ways of processing data. """
...
pdf_save_path = '/Users/williambishop/Desktop/dec_dep.pdf'


# ======================================================================================================================
# Here we specify a path to a folder we can use for saving temporary files (images)
temp_folder = '/Users/williambishop/Desktop/dec_dep'
